...
class EventTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # self.test_3 = []
        # self.test_4 = []
        with open('TestData/http-small.json') as f:
            for line in f:
                self.test_small.append(line)
    ...
    # def test_get_trades_by_stock_symbol(self):
    #     client = RequestsClient()
    ...
    # def test_get_trades_by_user_id_stock_symbol(self):
    #     client = RequestsClient()
